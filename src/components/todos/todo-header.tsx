      ...
      <div className="bg-gradient-to-r from-gray-800/20 via-gray-700/10 to-gray-800/20 rounded-xl p-6 border border-gray-700/30 shadow-lg backdrop-blur-sm">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 relative">
            ...
            {showHelp && (
              <div className="absolute top-14 left-1/2 transform -translate-x-1/2 sm:left-auto sm:right-0 bg-gradient-to-br from-[#1f1f1f] to-[#1a1a1a] border border-gray-700/50 rounded-xl p-5 w-72 sm:w-80 text-sm shadow-2xl shadow-black/30 z-20 animate-in slide-in-from-top-2 duration-200">
